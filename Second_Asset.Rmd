...
### Number of Negative/Positive interview experience in the top 10 job openings in Amazon
```{r}
...
### Number of Accepted/Rejected job offer in the top 10 Amazon's offices
```{r}
